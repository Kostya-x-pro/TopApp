		...
		<div className={className} ref={ref} {...otherProps}>
			<Card className={styles.product}>
				...
				<div className={styles.price}>
					<span><span className="visualyHidden"></span>{priceRU(product.price)}</span>
				...
				<div className={styles.rateTitle}>
					<a href="#ref" onClick={scrollToReview}>{product.reviewCount} {declOfNum(product.reviewCount, ['отзыв', 'отзыва', 'отзывов'])}</a></div>
				...
				<div className={styles.actions}>
					...
					<Button
						...
						aria-label="Кнопка читать отзывы" 
